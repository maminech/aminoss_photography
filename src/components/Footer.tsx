    ...
    <footer className="bg-gray-900 dark:bg-dark-800 text-gray-300 dark:text-gray-400 border-t border-gray-800 dark:border-gray-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-base sm:text-lg font-semibold text-white dark:text-gray-200 mb-3 sm:mb-4">Quick Links</h4>
            <ul className="space-y-2">
              <li>
                <Link href="/gallery" className="text-sm hover:text-primary-400 dark:hover:text-primary-500 transition-colors inline-block min-h-[44px] flex items-center">
                  Gallery
                </Link>
              </li>
              <li>
                <Link href="/videos" className="text-sm hover:text-primary-400 dark:hover:text-primary-500 transition-colors inline-block min-h-[44px] flex items-center">
                  Videos
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/contact" className="text-sm hover:text-primary-400 dark:hover:text-primary-500 transition-colors inline-block min-h-[44px] flex items-center">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div className="sm:col-span-2 md:col-span-1">
            <h4 className="text-base sm:text-lg font-semibold text-white dark:text-gray-200 mb-3 sm:mb-4">Connect</h4>
            <div className="flex gap-3 sm:gap-4 mb-3 sm:mb-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="p-2.5 sm:p-3 min-w-[44px] min-h-[44px] bg-gray-800 dark:bg-dark-700 rounded-full hover:bg-primary-600 dark:hover:bg-primary-600 transition-colors flex items-center justify-center"
