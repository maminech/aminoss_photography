                ...
                {booking.events && Array.isArray(booking.events) && booking.events.length > 0 && (
                  <div className="bg-gradient-to-r from-primary/5 to-transparent rounded-xl p-4 border border-primary/10">
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                      ...
                      Détails des événements ({booking.events.length})
                    </h3>
                    <div className="space-y-3">
                      {booking.events.map((event: any, index: number) => (
                        <div key={index} className="bg-white dark:bg-dark-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                          <div className="flex items-start justify-between mb-3">
                            <h4 className="font-semibold text-primary text-lg">Événement {index + 1}</h4>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            ...
                            <div className="flex items-start gap-2">
                              ...
                              <div>
                                <span className="text-gray-500 dark:text-gray-400 block text-xs">Heure</span>
                                <p className="font-medium text-gray-900 dark:text-white">{event.timeSlot || 'Non spécifié'}</p>
                              </div>
                            </div>
                            {event.packageType && (
                              <div className="flex items-start gap-2">
                                ...
                                <div>
                                  <span className="text-gray-500 dark:text-gray-400 block text-xs">Photographe</span>
                                  <p className="font-medium text-gray-900 dark:text-white">
                                    {event.packageType === 'aymen' ? 'Par Aymen' : 'Par Équipe'}
                                  </p>
                                </div>
                              </div>
                            )}
                            {event.packageLevel && (
                              <div className="flex items-start gap-2">
                                ...
                                <div>
                                  <span className="text-gray-500 dark:text-gray-400 block text-xs">Pack</span>
