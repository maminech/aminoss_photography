...
async function organizeCloudinary() {
  try {
    ...
    console.log('   node scripts/cleanup.js confirm\n');

    // If confirm argument is passed, delete the photos
    if (process.argv.includes('confirm')) {
      ...
      console.log(`\n✨ Cleanup complete! Deleted ${deleted} photos.`);
      console.log(`\n📸 Your ${toKeep.length} photos are safe and ready to use!\n`);
    }
